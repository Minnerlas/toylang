...
var_list: VAR IDENT ':' IDENT 			{ $$ = new_ast_vardec(lineno, $2, $4); }
		| var_list ',' IDENT ':' IDENT	{ $$ = add_ast_vardec($1, $3, $5); }
		;
...
stmt: ';'								{ $$ = new_ast_stmt_null(lineno); }
	...
	| var_list ';'						{ $$ = new_ast_stmt_vardec(lineno, $1); }
	;
...
expr: LIT_INTEGER				{ $$ = $1; }
	...
	| expr PP 					{ $$ = new_ast_op(lineno, AST_POSLPP,    $1, NULL, NULL); }
	| expr MM 					{ $$ = new_ast_op(lineno, AST_POSLMM,    $1, NULL, NULL); }
